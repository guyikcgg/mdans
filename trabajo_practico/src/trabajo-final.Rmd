...
\includesvg{img/knime/cluster-scheme2-k-means}
...
\includesvg{img/knime/cluster-scatterplot-before-k-means}
...
\includesvg{img/knime/cluster-scatterplot-after-k-means}
...
\includesvg{img/knime/cluster-quality-k-means}
\includesvg{img/knime/cluster-score-k-means}
...
\includesvg{img/knime/cluster-scheme2-dbscan}
...
\includesvg{img/knime/cluster-scatterplot-after-dbscan}
...
\includesvg{img/knime/cluster-quality-dbscan}
\includesvg{img/knime/cluster-score-dbscan}
...
\includesvg{img/knime/cluster-scheme2-k-medoids}
...
A continuación se representan gráficamente los resultados obtenidos por el clustering con k-Medoids. Cada cluster se ha rerpresentado de un color diferente.Los distintos colores representan los clusters encontrados. En gris se representa el ruido. Los ejes son los mismos usados para las otras figuras.

\includesvg{img/knime/cluster-scatterplot-after-k-medoids}
...
\includesvg{img/knime/cluster-quality-k-medoids}
\includesvg{img/knime/cluster-score-k-medoids}
